...
public class DemoWithoutWaitTest extends BaseTest {
     ...
     */
    @Test
    public void testAsyncContentWithoutWait() throws Exception {
        System.out.println("\n╔════════════════════════════════════════════════════════════════╗");
        ...
        try {
            ...
            pauseForDemo(); // ⏱️ Pausa para ver el click y el loading
            ...
            pauseForDemo(2000); // ⏱️ Pausa más larga para leer el error
     ...
     */
    @Test
    public void testClickableElementWithoutWait() throws Exception {
        System.out.println("\n╔════════════════════════════════════════════════════════════════╗");
    ...
    public void testDynamicTextWithoutWait() {
        ...
        pauseForDemo(); // ⏱️ Pausa para ver el click
        ...
        if (statusText.contains("Procesando datos...")) {
            ...
            pauseForDemo(2000); // ⏱️ Pausa más larga para leer el mensaje de fallo
     ...
     */
    @Test
    public void testOverlayWithoutWait() throws Exception {
        System.out.println("\n╔════════════════════════════════════════════════════════════════╗");
